...
var ControlBar = React.createClass({displayName: "ControlBar",
  ...
  populateControlBar: function() {
    ...
    var controlItemTemplates = {
      ...
      "toggleSpeed": React.createElement("button", {className: "oo-toggle-speed oo-control-bar-item", onClick: this.handleToggleSpeed, key: "toggleSpeed"}, 
        React.createElement(Icon, React.__spread({},  this.props, {icon: speedIcon, 
          style: dynamicStyles.iconCharacter, 
          onMouseOver: this.highlight, onMouseOut: this.removeHighlight}))
      ),
...
OO.plugin("Html5Skin", function (OO, _, $, W) {
  ...
  if (OO.publicApi && OO.publicApi.VERSION) {
    ...
    OO.publicApi.VERSION.skin_version = "1305a8cafc6b7d01b3f5fff8ab79a19a6bd956c7";
  }
